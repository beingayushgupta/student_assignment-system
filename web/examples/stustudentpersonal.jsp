            ...
            <div  style="margin-top:50px;margin-left:350px;"class="rcorners1">
                ...
                <%
                  ...
                  <div class="rcorners2">
                      ...
                      <a href="#" class="youtube-link" youtubeid="PBSpokSipWw">Bubble Sort</a><br><br>
                      <a href="#" class="youtube-link" youtubeid="7h1s2SojIRw">Quick Sort</a><br><br>
                      <a href="#" class="youtube-link" youtubeid="BO145HIUHRg">Insertion Sort</a><br><br>
                      <a href="#" class="youtube-link" youtubeid="j6iP4lDTKyI">Heap Sort</a><br><br>
                      <a href="#" class="youtube-link" youtubeid="wWgIAphfn2U">Hash Sort</a><br><br>
                      </center>
